...
const MemberRegi = () => {
  ...
  /* for Member registration closed */
  if (!data1.Member) {
    return <NotFound value="Currently Member Registration closed"/>
  }
  
  /* for Member registration open */
  return (
    <div>
      <ToastContainer/>
      <div className="container ContainerMargin">
        <div className="row text-center">
           <LOGO/>
          <h1 className='HeadingPageName my-4'>Member Registration Form</h1>
        </div>
